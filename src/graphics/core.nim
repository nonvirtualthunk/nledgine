...
proc draw* [VT; IT : uint16 | uint32, TT : Texture](vao : Vao[VT, IT], shader : Shader, textures : seq[TT], camera : Camera, renderSettings : RenderSettings = defaultRenderSettings()) : DrawCommand =
    if vao.id == 0:
