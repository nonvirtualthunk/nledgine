...
type
  ...
  GridFieldModification*[W : static[int], H : static[int], D : static[int], C, T] = ref object of AbstractModification
    field*: Field[C, FiniteGrid3D[W, H, D, T]]
    x*: int
    y*: int
    z*: int
    operation*: TaggedOperation[T]
...
method apply*[W : static[int], H : static[int], D : static[int], C, T](modification: GridFieldModification[W, H, D, C, T], target: ref C) {.base.} =
  modification.operation.apply(modification.field.varGetter(target[])[modification.x, modification.y, modification.z])
...
method apply*[W : static[int], H : static[int], D : static[int], C, T](modification: GridFieldModification[W, H, D, C, T], target: var C) {.base.} =
  modification.operation.apply(modification.field.varGetter(target)[modification.x, modification.y, modification.z])
...
proc put*[W : static[int], H : static[int], D : static[int], C, T](field: Field[C, FiniteGrid3D[W, H, D, T]], x: int, y: int, z: int, delta: T) : GridFieldModification[W,H,D,C,T] =
  GridFieldModification[W,H,D,C,T](field: field, x: x, y: y, z: z, operation: TaggedOperation[T](kind: OperationKind.Set, arg: delta))

proc set*[W : static[int], H : static[int], D : static[int], C, T](field: Field[C, FiniteGrid3D[W, H, D, T]], x: int, y: int, z: int, delta: T) : GridFieldModification[W,H,D,C,T] =
  GridFieldModification[W,H,D,C,T](field: field, x: x, y: y, z: z, operation: TaggedOperation[T](kind: OperationKind.Set, arg: delta))
